# PMP CODE 
#Scenario 2 and 3  internal water market individual code for Delicias using Evapotranspiration (FAO EQ.56 AND IRRIGATION METHODS)
#%% Library import
import os
import numpy as np
...
region = {"Delicias": {"volumen_mm3": 976309.62, "lamina_reportada": 1.44}} # en m 
volumen_hm3_distritos = {distrito: region[distrito]["volumen_mm3"] / 1_000 for distrito in region} 
# Delicias_005 Data
data = {
    'Delicias': {
        'Cacahuate': {'price': 11713, 'yield':4, 'cost': 32170, 'land': 4041, 'Evapotranspiration':54.96,'IRMETHOD':'Asperción', 'METHODEF':.75, 'Ky':.7},#METHODEF es la eficiencia del metodo de irrigación
        ...
        'NuezdeNogal': {'price': 72522, 'yield': 2.5, 'cost': 94148, 'land': 14202, 'Evapotranspiration':119.31,'IRMETHOD':'Asperción', 'METHODEF':.75, 'Ky':1.2}}}
#%% Initial Equations 
